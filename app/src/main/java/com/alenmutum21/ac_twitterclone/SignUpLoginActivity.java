            ...
            public void onClick(View v) {
                ...
                appUser.signUpInBackground(new SignUpCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e == null){
                            FancyToast.makeText(SignUpLoginActivity.this,appUser.getUsername()+" succesfully signed up",FancyToast.LENGTH_LONG,FancyToast.SUCCESS,false).show();
                            Intent sendUserToWelcomeActivity = new Intent(SignUpLoginActivity.this, WelcomeActivity.class);
                            startActivity(sendUserToWelcomeActivity);
                            finish();
                ...
                ParseUser.logInInBackground(usernameLogin.getText().toString(), pwdLogin.getText().toString(), new LogInCallback() {
                    ...
                    public void done(ParseUser user, ParseException e) {
                        if (user != null && e == null){
                            ...
                            Intent sendUserToWelcomeActivity = new Intent(SignUpLoginActivity.this, WelcomeActivity.class);
                            sendUserToWelcomeActivity.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(sendUserToWelcomeActivity);
                            finish();
